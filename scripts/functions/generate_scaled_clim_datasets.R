...
# Function to scale (i.e. mean-center and divide by sd) the climatic datasets to be used for the genomic offset predictions
# Climatic data of the reference and future periods are scaled based on the mean and standard-deviation of the climatic data of the reference period.
...
clim_pred <- readRDS(here("data/climatic_data/future_climate_population_locations.rds"))
}
