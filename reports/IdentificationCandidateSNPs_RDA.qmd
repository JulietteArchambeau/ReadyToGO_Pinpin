...
# ===================================
geno_pop <- read_csv(here("data/genomic_data/imputed_allele_frequencies_withoutmaf.csv")) %>% 
...
```{r LoadImtGenDataMAF}
geno_pop_maf <- read_csv(here("data/genomic_data/imputed_allele_frequencies_withmaf.csv")) %>% 
  column_to_rownames("pop")

kable_mydf(geno_pop_maf[1:10,1:8], boldfirstcolumn = T)
```
